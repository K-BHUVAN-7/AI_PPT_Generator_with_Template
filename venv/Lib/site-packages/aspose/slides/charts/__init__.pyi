...
class ChartDataPointCollection:
    ...
    def add_data_point_for_stock_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    ...
                    (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_stock` method).
    ...
    def add_data_point_for_line_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Line subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_line` method).
        :param value: Data point Value.
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_scatter_series(self, x_value: IChartDataCell, y_value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Scatter subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_scatter` method).
    ...
    def add_data_point_for_radar_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Radar subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_radar` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_bar_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Column or Bar subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_column` and :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_bar` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_area_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Area subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_area` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_pie_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Pie subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_pie` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_doughnut_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Doughnut subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_doughnut` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
    ...
    def add_data_point_for_bubble_series(self, x_value: IChartDataCell, y_value: IChartDataCell, bubble_size: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Bubble subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_bubble` method).
        :param x_value: Data point XValue
        :param y_value: Data point YValue
    ...
    def add_data_point_for_surface_series(self, value: IChartDataCell) -> IChartDataPoint:
        '''Creates the new data point and adds it to the end of collection.
                    Applicable for series which chartType is one of Surface subtypes (see also :py:func:`aspose.slides.charts.ChartTypeCharacterizer.is_chart_type_surface` method).
        :param value: Data point Value
        :returns: New data point.'''
        ...
...
class IChartData:
    ...
    def read_workbook_stream(self) -> io.RawIOBase:
        ...
        :returns: Returns an instance of ``MemoryStream`` containing a copy of the internally contained Excel workbook.'''
        ...
